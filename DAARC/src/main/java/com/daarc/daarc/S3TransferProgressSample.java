 ...
 * (/home/rounak/.aws/credentials) where the sample code will load the credentials from.
 * <p>
...
public class S3TransferProgressSample {
    ...
    public static void main(String[] args) throws Exception {
        /*
         * The ProfileCredentialsProvider will return your [DAARC]
         * credential profile by reading from the credentials file located at
         * (/home/rounak/.aws/credentials).
         *
         * TransferManager manages a pool of threads, so we create a
         * single instance and share it throughout our application.
         */
        try {
            credentials = new ProfileCredentialsProvider("DAARC").getCredentials();
        } catch (Exception e) {
            throw new AmazonClientException(
                    "Cannot load the credentials from the credential profiles file. " +
                    "Please make sure that your credentials file is at the correct " +
                    "location (/home/rounak/.aws/credentials), and is in valid format.",
                    e);
        }
